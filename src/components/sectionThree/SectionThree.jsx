...
const SectionThree = () => {
    ...
    const products = [
        { id: 11, title: 'Ahava სასაჩუქრე ნაკრები Mud About You', description: 'მოცულობა: 50 მლ / 100 მლ / 40 მლ', image: '/present1.webp', price: '584₾', salePrice: '342₾', additionalImages: ['/present1.webp'] },
        { id: 12, title: 'Byphasse სასაჩუქრე ნაკრები', description: 'რაოდენობა შეფუთვაში: 6 ცალი', image: '/present2.webp', price: '62₾', salePrice: '30₾', additionalImages: ['/present2.webp', '/present22.webp', '/present333.webp'] },
        { id: 13, title: 'Ahava ნაკრები Apple of My Eye', description: 'მოცულობა: 50 მლ/ 50 მლ/ 15 მლ', image: '/present3.webp', price: '57₾', salePrice: '19₾', additionalImages: ['/present3.webp'] },
        { id: 14, title: 'Ahava სასაჩუქრე ნაკრები Strike Gold', description: 'მოცულობა: 6 მლ / 40 მლ / 15 მლ', image: '/present4.webp', price: '198₾', additionalImages: ['/present4.webp'] },
        { id: 15, title: 'Ahava - ნაკრები სამგზავრო მამაკაცის NEW', description: 'პროდუქტის ტიპი: ნაკრები', image: '/present5.webp', price: '197₾', salePrice: '75₾', additionalImages: ['/present5.webp'] },
        { id: 16, title: 'ნაოჭების საწინააღმდეგო კრემი', description: 'ატენიანებს ღრმად', image: '/present6.webp', price: '120₾', salePrice: '60₾', additionalImages: ['/present6.webp']  },
    ];
