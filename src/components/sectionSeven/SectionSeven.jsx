...
const SectionSeven = () => {
    ...
    const products = [
        { id: 11, title: 'ორადგილიანი ბუდე საქანელა', description: 'კალათის ზომა: 145 x 100 x 135 სმ, მაქსიმალური დატვირთვა: 200კგ', image: '/e1.webp', price: '999₾', salePrice: '485₾', additionalImages: ['/e1.webp'] },
        { id: 12, title: 'ბაღის ავეჯის კომპლექტი', description: 'მასალა: როტანგი / რკინა', image: '/e2.webp', price: '3299₾', salePrice: '1745₾', additionalImages: ['/e2.webp'] },
        { id: 13, title: 'ერთადგილიანი წითელი ჰამაკი 180 x 75 სმ', description: 'წითელი, ტილო, 190 x 100 სმ', image: '/e3.webp', price: '70₾', salePrice: '40₾', additionalImages: ['/e3.webp'] },
        { id: 14, title: 'ბუდე საქანელა ნაცრისფერი ბალიშით', description: 'ნაცრისფერი ბუდე საქანელა', image: '/e4.webp', price: '499₾', salePrice: '259₾', additionalImages: ['/e4.webp'] },
    ...
    return (
        <div className="mx-auto max-w-[1300px] w-[90%] mt-12 flex flex-col">
            <h2 className="text-2xl font-bold mb-4">ეზოს ავეჯი 60%-მდე ფასდაკლებით</h2>
