...
const SectionEight = () => {
    ...
    const products = [
        { id: 11, title: 'Bino დეკორატიული თარო 40 x 15 x 40 სმ', description: 'ფერი: ოქროსფერი, ხისფერი', image: '/a1.webp', price: '69₾', salePrice: '55₾', additionalImages: ['/a1.webp'] },
        { id: 12, title: 'ტორშერი MS461', description: 'ფერი: შავი/თეთრი, სიმაღლე: 135სმ', image: '/a2.webp', price: '149₾', salePrice: '73₾', additionalImages: ['/e2.webp'] },
        { id: 13, title: 'ჭაღი 70 x 21 სმ BG-433', description: 'ფერი: ცისფერი, ზომა: 70 x 21 სმ', image: '/a3.webp', price: '49₾', salePrice: '26₾', additionalImages: ['/e3.webp'] },
        { id: 14, title: 'My Mob კომოდი 86x70x40 სმ', description: 'მასალა: ხე, ფერი: თეთრი', image: '/a4.jpg', price: '499₾', additionalImages: ['/e4.webp'] },
    ...
    return (
        <div className="mx-auto max-w-[1300px] w-[90%] mt-12 flex flex-col">
            <h2 className="text-2xl font-bold mb-4">ავეჯი</h2>
